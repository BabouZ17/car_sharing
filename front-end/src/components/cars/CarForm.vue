<template>
  <v-form v-model="valid" ref="form">
    ...
    <v-flex md6 offset-md3>
      <v-card>
        <v-card-title v-if="car.model != undefined">Edit of car: {{ car.model }}</v-card-title>
        <v-card-title v-else>New car</v-card-title>
        <v-card-text>
          <v-container grid-list-xl justify-center="True">
            <v-layout wrap>
            ...
            <v-layout justify-center="True">
              <v-btn :disabled="!valid" color="success" class="mr-4" @click="submit">Validate</v-btn>
...
export default {
  ...
  methods: {
    ...mapActions([carsActions.CREATE_CAR]),
